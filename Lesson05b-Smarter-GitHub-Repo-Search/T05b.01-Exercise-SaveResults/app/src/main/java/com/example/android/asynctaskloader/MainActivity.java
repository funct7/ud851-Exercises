...
public class MainActivity extends AppCompatActivity {
    ...
    final static private String QUERY_URL = "query_url";

    // TODO (2) Create a static final key to store the search's raw JSON
    final static private String RAW_JSON = "raw_json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null
                && savedInstanceState.containsKey(QUERY_URL)
                && savedInstanceState.containsKey(RAW_JSON)) {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String content = mUrlDisplayTextView.getText().toString();
        outState.putString(QUERY_URL, content);

        String results = mSearchResultsTextView.getText().toString();
        outState.putString(RAW_JSON, results);
    }

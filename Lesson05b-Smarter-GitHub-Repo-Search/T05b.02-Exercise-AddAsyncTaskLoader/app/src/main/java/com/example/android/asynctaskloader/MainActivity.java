...
//    private static final String SEARCH_RESULTS_RAW_JSON = "results";
    ...
    private static final int GITHUB_SEARCH_LOADER = 1111;
...
//            mSearchResultsTextView.setText(rawJsonSearchResults);
    ...
    private void makeGithubSearchQuery() {
        ...
        Log.d("Main_githubSearch", "making search query");
...
//        new GithubQueryTask().execute(githubSearchUrl);
    ...
    public Loader<String> onCreateLoader(int i, final Bundle bundle) {
        ...
        Log.d("Main_onCreateLoad", "creating loader with " + bundle);
        ...
        return new AsyncTaskLoader<String>(this) {
            ...
            protected void onStartLoading() {
                ...
                Log.d("AsyncLoader_onStart", "on start loading with bundle " + bundle);
    ...
    public void onLoadFinished(Loader<String> loader, String s) {
        ...
        Log.d("Main_onLoadFin", "result length: " + s.length());
    ...
    public void onLoaderReset(Loader<String> loader) {
        Log.d("Main_onLoadReset", "Resetting the loader");
    }

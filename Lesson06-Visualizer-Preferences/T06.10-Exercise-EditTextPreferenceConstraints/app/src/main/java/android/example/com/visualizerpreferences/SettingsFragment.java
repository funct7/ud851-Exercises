...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle bundle, String s) {
        ...
        EditTextPreference pref = (EditTextPreference) findPreference(getString(R.string.pref_size_key));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        try {
            ...
            if (value >= 0 && value <= 3) {
                ...
                showToastWithMessage("Please input a value [0, 3]");
                return false;
            }
        } catch (NumberFormatException e) {
            e.printStackTrace();
            showToastWithMessage("Only numbers are allowed");
            return false;
        }
